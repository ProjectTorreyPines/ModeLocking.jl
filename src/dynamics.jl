...
"""
    solve_ODEs(ode_params, application, n_mode, control_type, t_final, time_steps, C1, C2; full_output=false)
...
"""
function solve_ODEs(ode_params::ODEparams, application::String, n_mode::Int, control_type::Symbol,
...
"""
    solve_grid(ode_params, application, n_mode, control_type, t_final, time_steps) → Matrix{Float64}
...
"""
function solve_grid(ode_params::ODEparams, application::String, n_mode::Int, control_type::Symbol,
    ...
    finals = pmap(inputs) do (C1, C2)
        solve_ODEs(ode_params_send, application, n_mode, control_type, t_final, time_steps, C1, C2)
    end
...
"""
    solve_and_classify(ode_params, application, n_mode, control_type, t_final, time_steps,
                        NL_saturation_ON, grid_size) → LockingResults
...
"""
function solve_and_classify(ode_params::ODEparams, application::String, n_mode::Int, control_type::Symbol,
                              t_final::Real, time_steps::Int, NL_saturation_ON::Bool, grid_size::Int)
    control1 = ode_params.Control1
    control2 = ode_params.Control2
    ode_sols = solve_grid(ode_params, application, n_mode, control_type, t_final, time_steps)
    ...
    bifurcation_bounds = NL_saturation_ON ? nothing :
        calculate_bifurcation_bounds(ode_params, application, control_type, n_mode, grid_size)
...
"""
    calculate_bifurcation_bounds(ode_params, application, control_type, n_mode, grid_size) → Matrix{Float64}
...
function calculate_bifurcation_bounds(ode_params::ODEparams, application::String, control_type::Symbol,
    ...
    bifurcation_bounds = reshape(b.^2 ./ 4 .+ a.^3 ./ 27, grid_size, grid_size)
...
"""
    simulate_one_case(ode_params, application, n_mode, control_type, source_torque,
...
"""
function simulate_one_case(ode_params::ODEparams, application::String, n_mode::Int, control_type::Symbol,
    ...
    sol = solve_ODEs(ode_params, application, n_mode, control_type, t_final, time_steps, control1, control2; full_output=true)
